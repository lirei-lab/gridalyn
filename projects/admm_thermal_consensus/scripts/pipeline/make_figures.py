...
def main() -> None:
    ...
    ax2 = ax1.twinx()
    ax2.plot(imp["rho"], imp["worst_max_line_loading_pct"], "s--", color="tab:red", label="Max line loading [%]")
    ax2.axhline(C.LINE_LOADING_LIMIT_PCT, ls="--", color="tab:red", alpha=0.4)
    ax2.set_ylabel("Worst max line loading [%]")
