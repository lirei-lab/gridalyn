...
This paper closes the loop between coordination and feeder physics. Building on the
established sharing-ADMM paradigm for multi-agent demand response
\cite{boyd2011admm,Nguyen2018}, we pair it with machine-learning imputation of
non-responsive agents and \emph{extend} the pipeline with an AC power-flow
validation stage, turning a purely signal-level study into a network-validated one.
