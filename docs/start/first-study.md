...
- [Architecture Map](../components/overview.md)
- [Python SDK Overview](../components/overview.md)
- [Project Model](../components/projects.md)
...
[Build Your Own Project](../guides/build-your-own-project.md).

## 5. Choose Your Next Track

| Goal | Next page |
| --- | --- |
| Understand platform boundaries | [Platform, SDK, And Projects](../components/overview.md) |
| Use reusable Python surfaces | [SDK Public Contract](../components/foundation.md) |
| Build a new study | [Project Template Guide](../guides/project-template.md) |
| Understand operational workflows | [Utility Operations](../components/operations.md) |
| Compare executable examples | [Run Demo Projects](run-demo-projects.md) |
| Publish or review generated outputs | [Reports](../reference/report-schema.md) |
