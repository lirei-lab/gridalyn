...
writes figures and materializes operation artifacts. Its final
`build_study_reports` stage is still a stub — the canonical study report is
pending.
...
[`verification.md`](../contributing/verification.md) for the staged protocol.
...
- [Demo Projects](../components/projects.md)
- [Project Model](../components/projects.md)
- [Project Template Guide](../guides/project-template.md)
- [Workflow YAML Reference](../reference/workflow-yaml.md)
- [Reproducibility Checklist](../guides/reproducibility.md)
