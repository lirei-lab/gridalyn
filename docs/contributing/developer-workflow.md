...
- `development/documentation-map.md` if the reader path changes;
- `guides/reproducibility.md` if verification commands change;
- `components/overview.md` for system-level placement;
- `components/twin.md` for canonical data layout;
- `components/projects.md` for project contract behavior;
- `reference/report-schema.md` for report contract changes;
- `reference/semantic-graph.md` for ontology or graph changes;
- `components/interfaces.md` for visualization and catalog changes.
- `reference/artifact-policy.md` for Git, data, and generated-output policy.
