...
class DatasetAccessTest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.original_legacy_package_data = datasets.LEGACY_PACKAGE_DATA
        datasets.EXAMPLE_DATA_DIR = self.temp_data_dir
        datasets.LEGACY_PACKAGE_DATA = self.temp_data_dir

    def tearDown(self) -> None:
        shutil.rmtree(self.temp_data_dir)
        datasets.EXAMPLE_DATA_DIR = self.original_example_data_dir
        datasets.LEGACY_PACKAGE_DATA = self.original_legacy_package_data
