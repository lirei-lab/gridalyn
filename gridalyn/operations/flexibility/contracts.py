...
def validate_flexibility_operation_inputs(
    *,
    ...
    if errors:
        return FlexibilityOperationValidation(valid=False, errors=errors, warnings=warnings)
    ...
    scenario_impact = impact.loc[impact["scenario_id"].astype(str) == context.scenario_id]
    ...
    if provider_ids and impact_provider_ids and not provider_ids.intersection(impact_provider_ids):
