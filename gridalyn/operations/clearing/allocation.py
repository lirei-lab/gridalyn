"""Spatial ALLOCATION clearing core.

Maps an aggregate Soft/Hard CLS target back onto per-load matrices by
proportional reduction and headroom-based addition. Moved verbatim from
``market/spatial_cls.py``; this is the allocation half of the
allocation-vs-selection split (VERIF-03), distinct from the locational
SELECTION core in :mod:`gridalyn.operations.clearing.selection`.
"""
